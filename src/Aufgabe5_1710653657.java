...
public class Aufgabe5_1710653657 {
    ...
    public static void main(String[] args){
        ...
        int userzahl1 = Integer.parseInt(JOptionPane.showInputDialog("Bitte eine Zahl eingeben"));

        int userzahl2 = Integer.parseInt(JOptionPane.showInputDialog("Bitte eine weitere Zahl eingeben"));
